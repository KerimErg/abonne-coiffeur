...
(function () {
  ...
  function initHours() {
    ...
    if (isOpen) {
      ...
      statusEl.textContent = "Ouvert maintenant · jusqu'à 19h";
    } else {
      statusEl.classList.add("closed");
      if (isOpenDay && hour < OPEN_HOUR) {
        statusEl.textContent = "Fermé · ouvre aujourd'hui à 9h";
      } else if (day === 6) {
        statusEl.textContent = "Fermé · réouverture lundi à 9h";
      } else if (day === 0) {
        statusEl.textContent = "Fermé le dimanche · réouverture lundi à 9h";
      } else {
        statusEl.textContent = "Fermé · réouverture demain à 9h";
      }
    }
  }
